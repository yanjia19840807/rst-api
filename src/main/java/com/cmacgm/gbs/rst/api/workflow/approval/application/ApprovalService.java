...
import com.cmacgm.gbs.rst.api.workflow.approval.api.dto.ApprovalQueueItem;
import com.cmacgm.gbs.rst.api.workflow.approval.api.dto.ApprovalQueueView;
import com.cmacgm.gbs.rst.api.workflow.approval.api.dto.ApprovalWorkspaceView;
import com.cmacgm.gbs.rst.api.workflow.approval.api.dto.ApproveRequest;
import com.cmacgm.gbs.rst.api.workflow.approval.api.dto.QueueMetrics;
...
public class ApprovalService {
    ...
    private ApprovalDetailView toDetail(Loaded loaded, RstPrincipal principal) {
        ...
        boolean canDecide = loaded.workflow().isAwaitingReview()
    ...
    private boolean isAwaitingMyPosition(ProcessInstance workflow, Set<String> myPositions) {
        if (workflow == null || !workflow.isAwaitingReview()) {
            return false;
        }
